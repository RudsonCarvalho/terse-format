...
| File | Description |
|---|---|
| [spec/TERSE-Spec-v0.5.pdf](spec/TERSE-Spec-v0.5.pdf) | Full specification (PDF) |
| [spec/TERSE-Spec-v0.5.docx](spec/TERSE-Spec-v0.5.docx) | Full specification (Word) |
...
**Draft v0.5** — not yet ratified. The specification is open for community review. Sections 11 (Open Questions) and 13 (Security Considerations) are still under discussion. Target ratification: v1.0.
